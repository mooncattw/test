...
Services = setmetatable({}, {
	__index = function(self, name)
		local success, cache = pcall(function()
			return cloneref(game:GetService(name))... (232 KB kaldı)
...
faded hub.lua (1).txt
771 KB
@here 50 reactions for more leaks
Amir — dün 05:48
@everyone also 20 invites = access to op paid sources
✅
vortexRol simgesi, Sell access — dün 05:59
🙂
Amir — dün 19:47
İletildi
@everyone
...
Amir — dün 19:47
@here want this?
I remember I had the source long ago idk lmk
vortexRol simgesi, Sell access — dün 19:48
local TweenService     = game:GetService("TweenService")
local Players          = game:GetService("Players")
local UserInputService = game:GetService("UserInputService")
local HttpService      = game:GetService("HttpService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local SoundService     = game:GetService("SoundService")... (1 KB kaldı)

sticky’s gag 2 fake gift.txt
51 KB
Here
Hahaha
Amir — dün 19:48
ok nigger
〖ᴳᵒᵈ〗sᴜкᴜɴᴀ — dün 19:48
dms
Night🌙(very limited😭) [﷽ِ], Rol simgesi, Sell access — dün 19:58
@here 60 reactions for more leaks
Amir — 01:56
@here here's duel that never been leaked
	-- STRETCH REZ - Initialisation
...
message - 2026-07-16T235546.945.txt
133 KB
Amir — 06:06
@everyone if you wanna be a @Leaker baby (new) open ticket must leak daily and have good sources in exchange you take ticket sales / get paid
Must have good sources not ass once
Amir — 06:27
@here want this source

40 reactions
Ts never been leaked in any server
:emoji_95:
@here dang bro you don't want it
I see
Amir — 09:21
@here I'll leak ts at 8200 members we are close ✌️
Night🌙(very limited😭) [﷽ِ], Rol simgesi, Sell access — 15:11
Bro give me @Amir
Just the script idn the sorce
Amir — 15:32
local Players = game:GetService("Players")
local TweenService = game:GetService("TweenService")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
message - 2026-07-17T034935.404.txt
13 KB
Amir — 15:33
Instant steal I found it randomly when I was searching through my sources @here
@here want this source anti admin thing

Amir — 15:40
I think ts was made by @keo But idk
Yeah
﻿
local Players = game:GetService("Players")
local TweenService = game:GetService("TweenService")
