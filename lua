...
adam.mhlRol simgesi, Irish Hub Member — 00:03
@Source Leaker Who got a working anti bat

İletildi
-- ============================================================
-- ETHERNAL HUB ANTI BAT (ON / OFF Status Minimal UI)
-- ============================================================
...
message.txt
19 KB
CatinjapanRol simgesi, Irish Hub Member — 00:09
İletildi
Btw @here
-- Deobf by your daddy @DavidThe08
local CoreGui = game:GetService("CoreGui")
local Players = game:GetService("Players")
local TweenService = game:GetService("TweenService")

BirdHub_1 = Instance.new("ScreenGui")... (153 KB kaldı)
...
local LAGGER_CARRY_SPEED = 24.5... (16 KB kaldı)

Bird_Hub_PC.lua.txt
66 KB
2RareRol simgesi, Retired Right Hand — 01:48
@Source Leaker sorry for ping but send me some scripts that u want the ui to its not guaranteed that i get the ui but i can try 
Owner of every hubRol simgesi, moderator — 02:31
@Source Leaker sm1 leak a animation pack source
! ironic | zRol simgesi, On Top — 04:39
@Source Leaker leak rn
Elite_Agent🥶🍟Rol simgesi, Desync Buyer — 04:44
İletildi
...
SPECTRUM MOBILE.txt
131 KB
TrevRol simgesi, Irish Hub Member — 05:01
Vex reborn shit renewed features skidded plasma old source
...
local Workspace = game:GetService("Workspace")... (20 KB kaldı)

message.txt
70 KB
CatinjapanRol simgesi, Irish Hub Member — 13:41
İletildi
Görsel
...
Ruby lagger idk Polsec deobf.txt
18 KB
StickyBotRol simgesi, Irish Hub Member
UYG
 — 13:41
Stickied Message:

execute sources on a alt only
﻿
-- leaked by discord.gg/printedvs
-- Polsec De-obfuscation 90% correct
local Players = game:GetService("Players")
